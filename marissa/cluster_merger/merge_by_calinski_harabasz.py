...
class MergeByCalinskiHarabasz(ClusterMerger):
    def __init__(
        self,
    ...
    def merge(
        ...
        self.logger.info("Merging clusters by Calinski-Harabasz index")
        ...
        for cluster_id, cluster_packets in df.groupby("cluster"):
            for other_cluster_id, other_cluster_packets in df.groupby("cluster"):
                ...
                score = clusterizer.calculate_calinski_harabasz_score(
